      ...
      <div class="col">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <ul class="nav nav-tabs">
              <?php if($this->session->userdata("tipo") == 5 || $this->session->userdata("tipo") == 16 || $this->session->userdata("tipo") == 3){ ?>
              <li class="nav-item">
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tabIncidencias">
                ...
                <br/><br/>
                <a href="<?php echo base_url() ?>ControlVehicular/excel_incidencias" class="btn btn-secondary buttons-excel buttons-html5 btn-info" tabindex="0" aria-controls="data-table"><span><i class="fa fa-file-excel-o"></i> Exportar a Excel</span></a>
...
function mostrarTenencias(valorBuscar, pagina, valorBuscar2) {
  $.ajax({
...
function mostrarIncidencias(valorBuscar, pagina) {
  $.ajax({
    url: "<?= base_url() ?>ControlVehicular/mostrarTodasIncidencias",
    type: "POST",
    data: {
      buscar: valorBuscar,
      nropagina: pagina
