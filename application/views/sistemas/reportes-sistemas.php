    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header d-flex align-items-center">
                <h3 class="h4">Reportes Sistemas</h3>
            </div>
            <div class="card-body">
                <div class="over"></div>
          ...
          <?= $this->session->flashdata('errorReportesCV'); ?>
                ...
                <ul class="nav nav-tabs mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link btn active" id="pills-home-tab" data-toggle="pill" href="#pills-unidades"
                            role="tab" aria-controls="pills-unidades" aria-selected="true">
                            Unidades
                        </a>
                    </li>
                    <!--<li class="nav-item">
            ...
            <a class="nav-link btn" id="pills-home-tab" data-toggle="pill" href="#pills-operadores" role="tab" aria-controls="pills-operadores" aria-selected="true">
              Operadores
                ...
                <div class="tab-content" id="tabsContent">
                    <div class="tab-pane fade active show" id="pills-unidades" role="tabpanel"
                        aria-labelledby="pills-unidades-tab">
                        <?= form_open('sistemas/reporte_excel_sistemas', 'class="needs-validation" novalidate  id="formproyecto"'); ?>
                        <div class="form-row">
                            <div class="col-xs-12 col-md-5 col-lg-4">
                                <label class="form-check-label">Proyecto</label>
                                <select name="proyecto" id="selectProyecto" class="form-control proyecto"
                            ...
                            <div class="col-xs-12 col-md-4 col-lg-4">
                                ...
                                <select name="segmento" id="ssegmento" class="form-control segmento"
                                    data-live-search="true">
                                    <option value="" disabled="disabled" selected="selected">Seleccione...</option>
                                </select>
                            </div>
                    ...
                    <option value="cambio_propietario">Cambio Propietario</option>-->
                        ...
                        <div class="row">
                            ...
                            <div class="colxs-12 col-md-4">
                                ...
                                <input type="date" class="form-control fechaFinal" name="fecha_final"
                                    id="fecha_final_fecha">
                            </div>
                        </div>
                        <!--<div class="row">
                            <div class="col-3">
                                <label>Mecánico</label>
                                <select name="mecanico" id="mecanico" class="form-control mecanico"
                            ...
                            <div>
                                ...
                                <select id="rt0" name="rt0" class="form-control estatus" data-live-search="true"
                                    disabled="">
                    ...
                    <div class="tab-pane fade" id="pills-operadores" role="tabpanel"
                        aria-labelledby="pills-operadores-tab">
                        <?= form_open('almacen/reporte_excel_operaciones', 'class="needs-validation" novalidate  id="formproyecto"'); ?>
                        <div class="form-row">
                            <div class="col-xs-12 col-md-5 col-lg-4">
                                <label class="form-check-label">Proyecto*</label>
                                <select name="proyecto" id="selectProyecto2" class="selectpicker proyecto"
                                    data-live-search="true">
                                    <option value="" disabled="disabled" selected="selected">Seleccione...</option>
                                    <?php foreach ($proyectos as $key => $value): ?>
                                    <option value="<?php echo $value->idtbl_proyectos ?>"
                            ...
                            <div class="col-xs-12 col-md-4 col-lg-4">
                                <label>Segmento</label>
                                <select name="segmento" id="ssegmento2" class="selectpicker segmento"
                                    data-live-search="true">
                                    <option value="" disabled="disabled" selected="selected">Seleccione...</option>
                                </select>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <select name="productoo" id="product" class="selectpicker producto"
                                    data-live-search="true">
                                    <option value="" disabled="disabled" selected="selected">Seleccione...</option>
                                    <?php foreach ($catalogo as $key => $value): ?>
                                    <option value="<?php echo $value->idtbl_catalogo ?>"
                            ...
                            <div class="colxs-12 col-md-4">
                                <label class="form-check-label">Fecha Final*</label>
                                <input type="date" class="form-control fechaFinal" name="fecha_finall"
                                    id="fecha_final_fechas">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col text-right pt-5">
                    ...
                    <div class="tab-pane" id="servicios">
                        ...
                        <div class="form-row">
                            ...
                            <div class="colxs-12 col-md-4">
                                <label class="form-check-label">Fecha Final</label>
                                <input type="date" class="form-control fechaFinal" name="fecha_final"
                                    id="fecha_final_fechas" min="" max="<?= date('Y-m-d'); ?>">
                            </div>
                            <div class="col-4">
                            ...
                            <div class="col-4">
                                ...
                                <select name="estatus" id="estatus" class="form-control estatus"
                                    data-live-search="true">
                                    <option value="" disabled="disabled" selected="selected">Seleccione...</option>
                                    <option value="todos">Todos</option>
                                    <option value="pendiente">Pendiente</option>
                    ...
                    <div class="tab-pane" id="refacciones">
                        ...
                        <div class="form-row">
                            <div class="col-4">
                                ...
                                <select name="estatus_stock_minimo" id="estatus_stock_minimo"
                                    class="form-control estatus" data-live-search="true">
                                    <option value="todos">Todos</option>
                        ...
                        <div class="form-row">
                            ...
                            <div class="colxs-12 col-md-4">
                                ...
                                <select type="date" class="form-control" name="estatus" id="estatus">
                                    ...
                                    <option value="SU RCV">Aprobada por Almacen General</option>
                                    <option value="AG">Pendiente Aprobación AG</option>
                                    <option value="RCV">Pendiente Aprobación CV</option>
                                    <option value="cancelada RCV">Cancelada</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="colxs-12 col-md-4">
                                ...
                                <select name="modelo" id="modelo_reporte" class="form-control modelo"
                                    data-live-search="true">
                                    <option value="" disabled="disabled" selected="selected">Seleccione...</option>
                                    <?php foreach ($catalogo as $key => $value): ?>
                                    <option value="<?php echo $value->idtbl_catalogo ?>"
                            ...
                            <div class="colxs-12 col-md-4">
                                ...
                                <select name="eco_reporte" id="eco_reporte" class="form-control eco"
                                    data-live-search="true" disabled>
                                    <option value="" disabled="disabled" selected="selected">Seleccione...</option>
                                </select>
                            </div>
                    ...
                    <div class="tab-pane" id="caja_chica">
                        ...
                        <div class="form-row">
                            ...
                            <div class="colxs-12 col-md-4">
                                <label class="form-label">Modelo</label>
                                <select name="modelo" id="modelo_reporte_caja_chica" class="form-control modelo"
                                    data-live-search="true">
                                    <option value="" disabled="disabled" selected="selected">Seleccione...</option>
                                    <?php foreach ($catalogo as $key => $value): ?>
                                    <option value="<?php echo $value->idtbl_catalogo ?>"
                            ...
                            <div class="colxs-12 col-md-4">
                                <label class="form-label">Unidad</label>
                                <select name="eco_reporte" id="eco_reporte_caja_chica" class="form-control eco"
                                    data-live-search="true">
                                    <option value="" disabled="disabled" selected="selected">Seleccione...</option>
                                </select>
                            </div>
                    ...
                    <div class="tab-pane" id="combustible">
                        ...
                        <div class="form-row">
                            <div class="colxs-12 col-md-4">
                                <label class="form-label">Modelo</label>
                                <select name="modelo" id="modelo_reporte_combustible" class="form-control modelo"
                                    data-live-search="true">
                                    <option value="" disabled="disabled" selected="selected">Seleccione...</option>
                                    <?php foreach ($catalogo as $key => $value): ?>
                                    <option value="<?php echo $value->idtbl_catalogo ?>"
                            ...
                            <div class="colxs-12 col-md-4">
                                <label class="form-label">Unidad</label>
                                <select name="eco_reporte" id="eco_reporte_combustible" class="form-control eco"
                                    data-live-search="true">
                                    <option value="" disabled="disabled" selected="selected">Seleccione...</option>
                                </select>
                            </div>
