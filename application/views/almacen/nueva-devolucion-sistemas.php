<section class="forms nueva-asignacion">
  ...
  <div class="card">
    <div class="card-header d-flex align-items-center">
      <h3 class="h4">Nueva Solicitud de Devolución Sistemas</h3>
    </div>
    <div class="card-body">
      <div class="over"></div>
      ...
      <?= form_open_multipart('', 'class="needs-validation" novalidate id="form-asignacion"'); ?>
        ...
        <div id="item-producto1" class="itemproducto">
          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <input type="number" name="cantidad[]" id="cantidad" value="1" required class="form-control cantidad" step="0.001" min="0.001">
            </div>
            <div class="col">
        ...
        <div class="text-right">
          ...
          <?= form_hidden('tipo_devolucion','Sistemas') ?>
