  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-header d-flex align-items-center">
        <h3 class="h4">Reportes de almacen</h3>
      </div>
      <div class="card-body">
        <div class="over"></div>
        ...
        <ul class="nav nav-tabs mb-3" id="pills-tab" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link btn" id="pills-chica-tab" data-toggle="pill" href="#pills-chica" role="tab" aria-controls="pills-chica" aria-selected="false">
              Caja Chica
            </a>
          </li>
          <?php } ?>
          <?php if($this->session->userdata('tipo') == 19 || $this->session->userdata('id') == 216){ ?>
          <li class="nav-item">
            <a class="nav-link btn" id="pills-generador-tab" data-toggle="pill" href="#pills-generador" role="tab" aria-controls="pills-generador" aria-selected="false">
              Generador
            </a>
          </li>
          <?php } ?>
          <li class="nav-item">
            <a class="nav-link btn" id="pills-cuadre-tab" data-toggle="pill" href="#pills-cuadre" role="tab" aria-controls="pills-cuadre" aria-selected="false">
              Cuadre Proyecto
            </a>
          </li>
        ...
        <div class="tab-content" id="tabsContent">
              ...
              <div class="form-row">
                ...
                <div class="col-xs-12 col-md-3 col-lg-4">
                  ...
                  <select name="tipo_reporte" class="form-control" required>
                    ...
                    <option value="salida-virtual">Salidas Virtuales</option>
                ...
                <div class="col-xs-12 col-md-3 col-lg-4">
                  ...
                  <select name="almacen_reporte" class="form-control" required>
                    <option value="" disabled selected>Seleccione...</option>
                    <option value="todos">Todos</option>
                    <?php foreach($almacenes AS $key => $value){ ?>
                    <?php if($value->idtbl_almacenes != 28 && $value->idtbl_almacenes != 29 && $value->idtbl_almacenes != 30){ ?>
              ...
              <div class="form-row">
                ...
                <div class="col-xs-12 col-md-3 col-lg-4">
                  ...
                  <select name="almacen_reporte" class="form-control" required>
                    ...
                    <option value="todos">Todos</option>
                    <?php foreach($almacenes AS $key => $value){ ?>
                    <?php if($value->idtbl_almacenes != 2 && $value->idtbl_almacenes != 28 && $value->idtbl_almacenes != 29 && $value->idtbl_almacenes != 30){ ?>
                    <option value="<?= $value->idtbl_almacenes ?>"><?= $value->almacen ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>
            ...
            <?= form_open('almacen/reporte_excel', 'class="needs-validation" novalidate id="formalmacenes"'); ?>
              <div class="form-row">
                <div class="col-xs-12 col-md-4">
                  ...
                  <select name="almacen_reporte" class="selectpicker proyecto" required data-live-search="true">
                    <option value="" disabled selected>Seleccione...</option>
                    <option value="todos">Todos</option>
                    <option value="0">Seguridad e Higiene(Solo Neodata)</option>
                    <?php foreach ($almacenes as $key => $value): ?>
                ...
                <div class="col-xs-12 col-md-4">
                  ...
                  <select name="tipo_reporte" class="form-control" required>
                    ...
                    <option value="devolucion-almacen">Devoluciones</option>
                    <option value="traspaso-almacen">Traspasos</option>
                    <option value="cuadre materiales">Cuadre Materiales</option>
                    <option value="salidas_neodata">Salidas Neodata</option>
                    <option value="devoluciones_neodata">Devoluciones Neodata</option>                    
                    <option value="explosion_insumos">Explosión de insumos</option>
                    <option value="asignaciones">Asignados</option>
                    <option value="inventario_almacenes">Inventario</option>
                  </select>
                </div>
                <div class="col-xs-12 col-md-4">
                  <label class="form-check-label">Año*</label>
                    <?php for($i=2021; $i<=date('Y'); $i++){ ?>
                      <br><label><input class="" type="checkbox" name="anio[]" value="<?= $i ?>"><?= $i ?></label>
                      <?php } ?>
                  </select>
                </div>
              </div>
          ...
          <div class="tab-pane fade" id="pills-chica" role="tabpanel" aria-labelledby="pills-chica-tab">
            <?= form_open('almacen/reporte_excel', 'class="needs-validation" novalidate id="formalmacenes"'); ?>
              <div class="form-row">
                <div class="col-xs-12 col-md-6">
                  ...
                  <select name="almacen_reporte" class="form-control" required>
                    <option value="" disabled selected>Seleccione...</option>
                    <?php foreach ($almacenes as $key => $value): ?>
                      <?php if($value->idtbl_almacenes == 1){ ?>
                      <option value="<?php echo $value->idtbl_almacenes ?>">
                        <?php echo $value->almacen; ?>
                      </option>
                      <?php } ?>
              ...
              <div class="form-row">
                <div class="col text-right pt-5">
                  <?= form_hidden('token',$token) ?>
                  <?= form_hidden('tipo_reporte','entrada-almacen') ?>
                  <?= form_hidden('tipo_reporte','explosion_insumos') ?>
                  <?= form_hidden('tipo_de_reporte','caja_chica') ?>
                  <button type="submit" class="btn btn-primary">Generar</button>
                </div>
              </div>
            </form>
          ...
          <div class="tab-pane fade" id="pills-generador" role="tabpanel" aria-labelledby="pills-generador-tab">
            <?= form_open('almacen/reporte_excel', 'class="needs-validation" novalidate id="formalmacenes"'); ?>
              <div class="form-row">
                <div class="col-xs-12 col-md-6">
                  <label class="form-check-label">Almacenes*</label>
          ...
          <div class="tab-pane fade" id="pills-cuadre" role="tabpanel" aria-labelledby="pills-cuadre-tab">
            <?= form_open('almacen/reporte_excel', 'class="needs-validation" novalidate id="formalmacenes"'); ?>
              <div class="form-row">
                <div class="col-xs-12 col-md-6">
                  <label class="form-check-label">Almacenes Proyectos*</label>
                  <select name="almacen_reporte" class="form-control" required>
                    <option value="" disabled selected>Seleccione...</option>
                    <?php foreach ($proyectos_generadores as $key => $value): ?>
                      <option value="<?php echo $value->idtbl_almacenes ?>">
                        <?php echo $value->numero_proyecto . '-' . $value->nombre_proyecto; ?>
                      </option>
                    <?php endforeach ?>
                  </select>
                </div>
                <div class="col-xs-12 col-md-6">
                  ...
                  <select name="tipo_reporte" class="form-control" required>
                    <option value="" disabled selected>Seleccione...</option>
                      <option value="cuadre_proyecto">Cuadre Proyecto</option>
                      <option value="inventario">Inventario</option>
                      <option value="cuadre_explosion">Cuadre Explosion</option>
                      <option value="balance_general">Balance General</option>
                      <option value="balance_entrada">Balance Entradas</option>
                      <option value="balance_salidas">Balance Salidas</option>
                  </select>
                </div>
              ...
              <div class="form-row">
                <div class="col text-right pt-5">
                  <?= form_hidden('token',$token) ?>                  
                  <?= form_hidden('tipo_de_reporte','Cuadre') ?>
                  <button type="submit" class="btn btn-primary">Generar</button>
                </div>
              </div>
            </form>
