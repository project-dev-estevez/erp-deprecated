            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <h4><?php echo $almacen->almacen ?> / Autos</h4>
                    </div>
                    <div class="card-body">
...
<div id="editar_producto" role="dialog" class="modal fade text-left">
    <div role="document" class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12 col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Número de Serie" name="numero_serie"
                                class="form-control alto-costo" minlength="1" required <?= $this->session->userdata('modulo_activo') == 2  ? 'disabled' : '' ?>>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6">
                        <div class="form-group">
                            <label>Número Interno</label>
                            <input type="text" placeholder="Número Interno" name="numero_interno"
                                class="form-control alto-costo" minlength="1" required <?= $this->session->userdata('modulo_activo') == 2 ? 'disabled' : '' ?>>
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label>Placas</label>
                            <input type="text" placeholder="Placas" name="placas" class="form-control alto-costo"
                                minlength="1" required <?= $this->session->userdata('modulo_activo') == 2  ? 'disabled' : '' ?>>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label>Entidad federativa placas</label>
                            <select name="entidad_federativa" class="form-control alto-costo" <?= $this->session->userdata('modulo_activo') == 2 ? 'disabled' : '' ?>>
                                <option value="">Seleccionar</option>
                                <?php 
                            ...
                            <!--<input type="text" placeholder="Entidad federativa" name="entidad_federativa" class="form-control alto-costo"
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="No. motor" name="no_motor" class="form-control alto-costo"
                                minlength="1" required <?= $this->session->userdata('modulo_activo') == 2 ? 'disabled' : '' ?>>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <select name="tipo_combustible" class="form-control alto-costo" <?= $this->session->userdata('modulo_activo') == 2 ? 'disabled' : '' ?>>
                                <option value="">Seleccionar</option>
                                <option value="Gasolina">Gasolina</option>
                                <option value="Disel">Diésel</option>
                            </select>
                            <!--<input type="text" placeholder="Combustible" name="tipo_combustible" class="form-control alto-costo"
                                minlength="1" required>-->
                        </div>
                    </div>
                    <!--<div class="col-4">
            <div class="form-group">
              <label>Póliza</label>
              <input type="text" placeholder="Póliza" name="poliza" class="form-control alto-costo" minlength="1" required>
            </div>
          </div>
          <div class="col-4">
            <div class="form-group">
              <label>Seguro</label>
              <input type="text" placeholder="Seguro" name="seguro" class="form-control alto-costo" minlength="1" required>
            </div>
          </div>
          <div class="col-4">
            <div class="form-group">
              <label>Vigencia</label>
              <input type="date" placeholder="Vigencia" name="vigencia" class="form-control alto-costo" minlength="1" required>
            </div>
          </div>-->
                    <div class="col-6">
                        <div class="form-group">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="estado_vehiculo" id="nuevo"
                                value="nuevo" <?= $this->session->userdata('modulo_activo') == 2 ? 'disabled' : '' ?>>
                            <label class="form-check-label">
                                Nuevo
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="estado_vehiculo" id="usado"
                                value="usado" <?= $this->session->userdata('modulo_activo') == 2 ? 'disabled' : '' ?>>
                            <label class="form-check-label">
                                Usado
                            </label>
                        </div>
                    ...
                    <div class="col-6">
                        ...
                        <input type="number" placeholder="Kilometraje Actual" name="kmactual" class="form-control" <?= $this->session->userdata('modulo_activo') == 2 ? 'disabled' : '' ?>>
                    </div>
                    <div class="col-6">
                        <label>Próximo Servicio</label>
                        <input type="number" placeholder="Próximo Servicio" name="kmservicio" class="form-control" <?= $this->session->userdata('modulo_activo') == 2 ? 'disabled' : '' ?>>
                    </div>
                    <div class="col-6">
                        <label>Año</label>
                        <input type="number" placeholder="Año" name="anio" class="form-control" <?= $this->session->userdata('modulo_activo') == 2 ? 'disabled' : '' ?>>
                    </div>                    
                    <?php } else{ ?>
                        <div class="col-6">
                            <label>Kilometraje Actual</label>
                            <input type="number" placeholder="Kilometraje Actual" name="kmactual" class="form-control" disabled="true" <?= $this->session->userdata('modulo_activo') == 2 ? 'disabled' : '' ?>>
                        </div>
                        <div class="col-6">
                            <label>Próximo Servicio</label>
                            <input type="number" placeholder="Próximo Servicio" name="kmservicio" class="form-control" disabled="true" <?= $this->session->userdata('modulo_activo') == 2 ? 'disabled' : '' ?>>
                        </div>
                    <?php } ?>
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea placeholder="Descripción" name="nota" class="form-control"
                                minlength="4" <?= $this->session->userdata('modulo_activo') == 2 ? 'disabled' : '' ?>></textarea>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <label name="lblestatus">Estatus</label>
                            <select name="estatus" id="estatus" class="form-control alto-costo" required <?= $this->session->userdata('modulo_activo') == 2 ? 'disabled' : '' ?>>
                                ...
                                <option value="taller">Taller</option>
                                <?php if($this->session->userdata('id')==66 || $this->session->userdata('id')==271){ ?>
                                <option value="tramite vehicular">Tramite vehicular</option>
                                <?php } ?>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Ubicación" name="ubicacion" class="form-control" <?= $this->session->userdata('modulo_activo') == 2 ? 'disabled' : '' ?>>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <label>Propietario</label>
                            <input type="text" placeholder="Propietario" name="propietario" class="form-control" <?= $this->session->userdata('modulo_activo') == 2 ? 'disabled' : '' ?>>
                        </div>
                    </div>
                    <?php if($this->session->userdata('tipo') != 3) { ?>
                    <div class="col-12 col-lg-6">
                        <div class="form-group">
                            <label>Rack</label>
                            <select name="rack" class="form-control" <?= $this->session->userdata('modulo_activo') == 2 ? 'disabled' : '' ?>>
                                <option value="" disabled="disabled" selected="selected">Seleccione...</option>
                                <?php for ($x = 1; $x <= 20; $x++) { ?>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="form-group">
                            <label>Nivel</label>
                            <select name="nivel" class="form-control" <?= $this->session->userdata('modulo_activo') == 2 ? 'disabled' : '' ?>>
                                <option value="" disabled="disabled" selected="selected">Seleccione...</option>
                                <?php for ($x = 1; $x <= 10; $x++) { ?>
            ...
            <div class="modal-footer">
                ...
                <?php if($this->session->userdata('modulo_activo') != 2){ ?>
...
$('#editar_producto').on('show.bs.modal', function(event) {
    ...
    modal.find("input[name='propietario']").val(recipient.propietario);
        ...
        success: function(response) {
            ...
            $.each(response.almacenAutosControlVehicular, function(key, item) {
                ...
                if (item.estatus_asignacion == "activa") {
                    ...
                    filas += "<td><a href='#historialOperador' data-toggle='modal' data-idtbl_usuarios='' data-iddtl_almacen='" + item.iddtl_almacen +
                        "' data-operador='Sin asignación' >Sin asignación</a></td>";
                }
                filas += "<td>";
                ...
                filas +=
                    "<a href='#editar_producto' data-toggle='modal' title='Editar' data-propietario='" + item.propietario + "' data-ubicacion='" + item.ubicacion + "' data-anio='" + item.anio + "' data-estado_vehiculo='" +
                    item.estado + "' data-kmactual='" + item.km_actual +
                    "' data-kmservicio='" + item.km_servicio + "' data-tipo_vehiculo='" + item
                    .tipo_vehiculo + "' data-vigencia='" + item.vigencia + "' data-seguro='" + item
                    .seguro + "' data-poliza='" + item.poliza + "' data-no_motor='" + item
                    .no_motor + "' data-placas='" + item.placas_auto + "' data-serie='" + item
                    .numero_serie + "' data-interno='" + item.numero_interno + "' data-nota='" +
                    item.nota + "' data-estatus='" + item.estatusAlmacen + "' data-existencias='" + item
                    .existencias + "' data-rack='" + item.rack + "' data-nivel='" + item.nivel +
                    "' data-abreviatura='" + item.abreviatura + "' data-idalmacen='" + item
                    .iddtl_almacen + 
                    "' data-entidad-federativa='" + item.entidad_federativa_placas + "' data-tipo-combustible='"+ item.tipo_combustible + "'><i class='fa fa-edit'></i></a>";
                filas += "<a href='#opciones' data-toggle='modal' title='Opciones' data-interno='" +
                    item.numero_interno + "' data-servicio='" + servicio + "' data-iddtl_almacen='" + item.iddtl_almacen + "' data-kmactual='" + item.km_actual + "'><i class='fa fa-plus'></i></a>";
                <?php endif ?>
                filas += "</td>";
                filas += "</tr>";
            });
