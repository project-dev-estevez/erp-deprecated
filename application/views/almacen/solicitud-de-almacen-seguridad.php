  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-header d-flex align-items-center">
        <h3 class="h4">Nueva Solicitud de Almacen (Seguridad e Higiene)</h3>
      </div>
      <div class="card-body">
        <div class="over"></div>
        ...
        <?php echo form_open_multipart(base_url().'compras/enviar-solicitud', 'class="needs-validation" id="formuploadajax" novalidate'); ?>
              ...
              <select name="proyecto" id="selectProyecto" class="selectpicker proyecto" required data-live-search="true">
                ...
                <?php foreach ($proyectos as $key => $value): ?>
                  <option value="<?php echo $value->idtbl_proyectos ?>"
                    ...
                    <?php echo $value->numero_proyecto ?> - <?php echo substr(htmlspecialchars(trim($value->nombre_proyecto), ENT_COMPAT),0,70); ?>
                  </option>
                <?php endforeach ?>
              </select>
            </div>
          ...
          <div class="row">
            <div class="col">
              <div class="form-group">
                ...
                <select name="persona_autorizacion" id="" class="form-control recibe" required>
                  <option value="" disabled selected>Seleccione...</option>
                  <?php if (isset($persona_autorizacion)): ?>
                    <?php foreach ($persona_autorizacion as $key => $value): ?>
                      <option value="<?php echo $value->idtbl_users ?>"><?php echo $value->nombre ?></option>
                    <?php endforeach ?>
                  <?php endif ?>
                </select>
          ...
          <input type="hidden" name="tipo_producto" value="Seguridad e Higiene">
          <hr>
          <div id="item-producto1" class="itemproducto">
            <div class="form-row">
              ...
              <div class="col">
                ...
                <input type="number" name="cantidad[]" id="cantidad" required class="form-control" min="1">
              </div>
              <div class="col">
          ...
          <div class="clearfix pt-md">
            <div class="pull-right">
              ...
              <button type="submit" class="btn-primary btn" id="btn-enviar">Enviar Solicitud</button>
            </div>
          </div>
        <?=form_close()?>
      </div>
