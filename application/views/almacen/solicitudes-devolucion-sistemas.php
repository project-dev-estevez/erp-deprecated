  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-header d-flex align-items-center">
        <h3 class="h4">Mis solicitudes de devolución sistemas</h3>
      </div>
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table class="table table-striped table-sm table-hover" id="tbdevolucionessistemas">
            <thead>
              <tr>
                <th>UID</th>
                <th>Creación</th>
  ...
  function mostrarDatos(valorBuscar,pagina,valorBuscar2) {
    $.ajax({
      ...
      success:function(response) {
        ...
        $('#tbdevolucionessistemas tbody').html(filas);
