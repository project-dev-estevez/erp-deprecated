  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-header d-flex align-items-center">
        <h3 class="h4">Nueva Solicitud de Sistemas</h3>
      </div>
      <div class="card-body">
        <div class="over"></div>
        ...
        <?php echo form_open_multipart(base_url().'compras/enviar-solicitud', 'class="needs-validation" id="formuploadajax" onsubmit="return checkSubmit();" novalidate'); ?>
          ...
          <input type="hidden" name="tipo_producto" value="Sistemas">
          <hr>          
            <div id="item-producto1" class="itemproducto">
              <div id="hola" class="hola">
                ...
                <div class="form-row">
                  <div class="col">
                    ...
                    <!--input type="text" name="descripcion" id="descripcion" class="form-control descripcion" disabled-->
              ...
              <div class="campos_ac" style="display:none">
                <div class="form-row">
                  <div class="col">
                    <label>Producto</label>  
                    <?php foreach($chip as $sim=>$si){ ?>
                    <input type="text" name="" id="" class="form-control" value="<?php echo $si->neodata.' ('.substr(htmlspecialchars(trim($si->descripcion), ENT_COMPAT),0,70).')' ?>" disabled>                 
                    <input name="producto[]" id="product" class="selectpicker producto" type="hidden" value="<?php echo $si->idtbl_catalogo ?>">                                      
                    <?php } ?>
                  </div>                           
                  <div class="col">
                    <label for="cantidad">Cantidad</label>
                  ...
                  <div class="col">
                    <label for="unidad">Unidad</label>
                    <input value="<?php echo $si->unidad_medida ?>" type="text" disabled="true" class="form-control unidad">
                    <!--input type="text" disabled="true" class="form-control unidad"-->
                  </div>
                </div>
                <br>             
                <div class="form-row">
                  <div class="col">
                    <label for="especificaciones">Descripción</label>
                    <input value="<?php echo $si->descripcion ?>" type="text" name="" id="" class="form-control descripcin" disabled>
                  </div>
                </div>                    
                    <br>
                <div class="form-row">
