<div class="container-fluid">
	<div class="col-12">
	    ...
	    <h6 style="font-weight: normal" align="right" class="ecocheck">Eco: <strong><?php echo $checklist_asignacion[0]['numero_interno'] ?></strong></h6>
	    	<!--<div class="row">
		...
		<div class="form-group row">
			...
			<div class="col-3">
				<input type="text" class="form-control" value="<?= $checklist_asignacion[0]['kilometraje'] ?>" disabled>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-12">
							...
							<div class="table-responsive">
								<table class="table table-sm" width="100%">
									<tr>
										...
										<td>
											<center>
											<?php echo $checklist_asignacion[0]['nombre_usuario'] ?>
