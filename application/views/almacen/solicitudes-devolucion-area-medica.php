          ...
          <div class="bg-white has-shadow">
            <a href="<?= base_url() ?>almacen/solicitud-devolucion-area-medica" class="dropdown-item" title="">
              <div class="item d-flex align-items-center pr-4 pl-4">
                ...
                <div class="title">
                  <span>Nueva Solicitud<br> de Devolución Área Medica</span>
                </div>
              </div>
            </a>
          </div>
  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-header d-flex align-items-center">
        <h3 class="h4">Mis solicitudes de devolución alto costo</h3>
      </div>
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table class="table table-striped table-sm table-hover" id="tbdevolucionesac">
            <thead>
              <tr>
                <th>UID</th>
                <th>Creación</th>
  ...
  function mostrarDatos(valorBuscar,pagina,valorBuscar2) {
    $.ajax({
      ...
      success:function(response) {
        ...
        $('#tbdevolucionesac tbody').html(filas);
