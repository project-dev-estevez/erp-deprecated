<section class="forms nueva-asignacion">
  ...
  <div class="card">
    <div class="card-header d-flex align-items-center">
      <h3 class="h4">Nueva Solicitud de Devolución Autos Control Vehicular</h3>
    </div>
    <div class="card-body">
      <div class="over"></div>
      ...
      <?= form_open_multipart('', 'class="needs-validation" novalidate id="form-asignacion"'); ?>
        ...
        <div id="item-producto1" class="itemproducto productoFieldset">
          <hr>
          <div class="row">
            <div class="col-6">
              ...
              <select name="producto[]" id="product" class="selectpicker producto" required data-live-search="true">
                ...
                <?php foreach ($catalogo as $key => $value): ?>
                  <?php if ($value->origen == 1 && $this->session->userdata('tipo') == 5): ?>
                    <option value="<?php echo $value->idtbl_catalogo ?>"
                      ...
                      <?php echo $value->neodata.' '.$value->origen.' '.$value->modelo.' ('.substr(htmlspecialchars(trim($value->descripcion), ENT_COMPAT),0,30).')' ?>
                    </option>
            ...
            <div class="col">
              ...
              <input type="number" name="cantidad[]" id="cantidad" value="1" readonly required class="form-control cantidad" step="0.001" min="0.001">
            </div>
            <div class="col">
        ...
        <div class="text-right">
          ...
          <?= form_hidden('tipo_devolucion','Autos Control Vehicular') ?>
