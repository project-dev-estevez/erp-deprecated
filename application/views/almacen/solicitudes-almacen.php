  ...
  <section class="dashboard-counts no-padding-bottom botones">
    <div class="container-fluid">
      <div class="row">
        ...
        <!-- Item -->
        <!-- Item -->
        <?php if (isset($this->session->userdata('permisos')['solicitud_instalacion']) && $this->session->userdata('permisos')['solicitud_instalacion'] == 2 && $clase_pagina == 'solicitudes-almacen') { ?>
          <div class="col-xl-4 col-sm-6 col-md-5 col-xs-6 mb-2">
            <div class="bg-white has-shadow">
              <a href="<?= base_url() ?>almacen/solicitud-instalacion" class="dropdown-item" title="">
                <div class="item d-flex align-items-center pr-4 pl-4">
                  <div class="icon bg-violet">
                    <i class="fa fa-plus"></i>
                  </div>
                  <div class="title">
                    <span>Nueva<br> Solicitud<br>Instalación</span>
                  </div>
                </div>
              </a>
            </div>
...
<section class="tables dashboard-counts">
  <div class="container-fluid">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <?php if ($this->session->userdata('tipo') == 11) { ?>
          <ul class="nav nav-tabs mb-3" id="pills-tab" role="tablist">
            ...
            <?php } ?>
            <?php if (isset($this->session->userdata('permisos')['solicitud_instalacion']) && $this->session->userdata('permisos')['solicitud_instalacion'] > 0) { ?>
              <li class="nav-item">
                <a class="nav-link btn" id="pills-instalacion-tab" data-toggle="pill" href="#pills-instalacion" role="tab" aria-controls="pills-instalacion" aria-selected="false">
                  Instalación
                </a>
              </li>
            <?php } ?>
        ...
        <?php } ?>
        <?php if ((($this->session->userdata('tipo') == 4 && $clase_pagina == 'solicitudes-almacen') || $this->session->userdata('tipo') == 10 || $this->session->userdata('tipo') == 12 || $this->session->userdata('tipo') == 9 || ($this->session->userdata('encargado_almacen') != null && $this->session->userdata('encargado_almacen') != '') || $this->session->userdata('tipo') == 17 || ($this->session->userdata('tipo') == 3 && $clase_pagina == 'solicitudes-almacen') || ($this->session->userdata('tipo') == 2 && $clase_pagina == 'solicitudes-almacen') || $this->session->userdata('tipo') == 5 || $this->session->userdata('tipo') == 8) && $this->session->userdata('id')!=59) { ?>
          <ul class="nav nav-tabs mb-3" id="pills-tab" role="tablist">
            <li class="nav-item">
              <a class="nav-link btn active" id="pills-salida-tab" data-toggle="pill" href="#pills-salida" role="tab" aria-controls="pills-salida" aria-selected="true">
                Almacen general
            ...
            <?php if (($this->session->userdata('encargado_almacen') == null || $this->session->userdata('encargado_almacen') == '') || (($this->session->userdata('encargado_almacen') != null || $this->session->userdata('encargado_almacen') != '') && $clase_pagina == 'solicitudes-almacen')) { ?>
            <li class="nav-item">
              <a class="nav-link btn" id="pills-devolucion-tab" data-toggle="pill" href="#pills-devolucion" role="tab" aria-controls="pills-devolucion" aria-selected="false">
                Alto costo
              </a>
        ...
        <?php if ((((($this->session->userdata('tipo') == 4 && $clase_pagina != 'solicitudes-almacen') && !isset($_SESSION['tipo_anterior'])) || $this->session->userdata('tipo') == 6) && $this->session->userdata('id')!=50)) { ?>
          <ul class="nav nav-tabs mb-3" id="pills-tab" role="tablist">
            <li class="nav-item">
              <a class="nav-link btn active" id="pills-salida-tab" data-toggle="pill" href="#pills-salida" role="tab" aria-controls="pills-salida" aria-selected="true">
                Almacen general
            ...
            <li class="nav-item">
              <a class="nav-link btn" id="pills-87-tab" data-toggle="pill" href="#pills-87" role="tab" aria-controls="pills-87" aria-selected="false">
                87.09
              </a>
            </li>            
        ...
        <?php if($this->session->userdata('tipo') == 4 && isset($_SESSION['tipo_anterior'])) { ?>
          <ul class="nav nav-tabs mb-3" id="pills-tab" role="tablist">
            <li class="nav-item">
              <a class="nav-link btn active" id="pills-higiene-tab" data-toggle="pill" href="#pills-higiene" role="tab" aria-controls="pills-higiene" aria-selected="false">
                Seguridad e Higiene
              </a>
            </li>  
            <li class="nav-item">
                    ...
                    <?php if ($clase_pagina != 'solicitudes-almacen') { ?>
                      <th width="120">
                        <select name="selectRCV" style="font-size: 10px;" class="form-control">
                          ...
                          <option value="AG">Pendientes Aprobación Almacén General</option>
                          <?php } ?>
                          <?php if($this->session->userdata('tipo') == 6){ ?>
        ...
        <?php if (isset($this->session->userdata('permisos')['solicitud_instalacion']) && $this->session->userdata('permisos')['solicitud_instalacion'] > 0) { ?>
        <div class="tab-pane fade" id="pills-instalacion">          
          <div class="float-right">
            <input type="text" class="form-control" placeholder="Buscar" name="busquedaInstalacion">
          </div>
          <button onclick="window.location.href='<?php echo base_url() ?>almacen/excel-solicitudes-tarjetas'" class="btn btn-secondary buttons-excel buttons-html5 btn-info" tabindex="0" aria-controls="data-table"><span><i class="fa fa-file-excel-o"></i> Exportar a Excel</span></button>
          <div class="table-responsive">
            <table id="tbsolicitudesinstalacion" class="table table-striped table-sm">
              <thead>
                <tr>
                  <th>UID</th>
                  <th>Neodata</th>
            ...
            <br>
            <div class="paginacionInstalacion">
            </div>
        </div>
      </div>
        <?php } ?>
          ...
          <!--tab provisional-->
          <div class="tab-pane fade <?= $this->session->userdata('tipo') == 15 ? 'show active' : '' ?>" id="pills-87" role="tabpanel" aria-labelledby="pills-87-tab">
            <div class="float-right">
              <input type="text" class="form-control" placeholder="Buscar" name="busqueda87">
            </div>
            <!--button onclick="window.location.href='<?php echo base_url() ?>almacen/excel-solicitudes-rcv'" class="btn btn-secondary buttons-excel buttons-html5 btn-info" tabindex="0" aria-controls="data-table"><span><i class="fa fa-file-excel-o"></i> Exportar a Excel</span></button-->
            <div class="table-responsive">
              <table style="width: 100%" id="tbsolicitudes87" class="table table-striped table-sm">
                <thead>
                  <tr>
                    <th>UID</th>
                    <th>Neodata</th>
                ...
                <tfoot>
                  <tr>
                    ...
                    <?php if ($clase_pagina != 'solicitudes-almacen') { ?>
                      <th width="120">
                        <select name="select87" style="font-size: 10px;" class="form-control">
                          <option value="">Seleccionar</option>
                          <option value="SRCV">Surtida</option>
                          <option value="SU RCV">Aprobada por Control Vehicular</option>
                          <option value="cancelada RCV">Cancelada Control Vehicular</option>
          ...
          <?php } ?>
            ...
            <button onclick="window.location.href='<?php echo base_url() ?>almacen/excel_solicitudes_cv'" class="btn btn-secondary buttons-excel buttons-html5 btn-info" tabindex="0" aria-controls="data-table"><span><i class="fa fa-file-excel-o"></i> Exportar a Excel</span></button>
            <div class="table-responsive">
          ...
          <?php } ?>
          <?php if ((($this->session->userdata('tipo') != 4 && $this->session->userdata('tipo') != 6) || ($this->session->userdata('tipo') == 4 && isset($_SESSION['tipo_anterior'])) || $this->session->userdata('id')==50) && $this->session->userdata('tipo') != 10 && $this->session->userdata('tipo') != 3 && $this->session->userdata('tipo') != 2 && $this->session->userdata('tipo') != 11 && $this->session->userdata('tipo') != 12 && ($this->session->userdata('tipo') != 9 || $this->session->userdata('id')==59) && $this->session->userdata('tipo') != 5 && $this->session->userdata('tipo') != 8 && $this->session->userdata('tipo') != 17 && ($this->session->userdata('encargado_almacen') == null && $this->session->userdata('encargado_almacen') == '')) { ?>
            <div class="tab-pane fade" id="pills-salida" role="tabpanel" aria-labelledby="pills-salida-tab">
          <?php } else { ?>
            <div class="tab-pane fade show active" id="pills-salida" role="tabpanel" aria-labelledby="pills-salida-tab">
          <?php } ?>
          <!---->
          <?php if(((($this->session->userdata('tipo') == 4 && $clase_pagina != 'solicitudes-almacen') && !isset($_SESSION['tipo_anterior'])) && $this->session->userdata('id') != 50) || ($this->session->userdata('tipo') == 11)){ ?>
          <ul class="nav nav-tabs mb-3" id="pills-tab" role="tablist">
            <?php if($this->session->userdata('tipo') == 11){ ?>
            <li class="nav-item">
              <a class="nav-link btn active" id="pills-pendienteco-tab" data-toggle="pill" href="#pills-pendienteco" role="tab" aria-controls="pills-pendienteco" aria-selected="true">
                Pendiente Aprobación CO
              </a>
            </li>
            <?php } ?>
            <li class="nav-item">
              <a class="nav-link btn <?= $this->session->userdata('tipo') != 11 ? 'active' : '' ?>" id="pills-pendiente-tab" data-toggle="pill" href="#pills-pendiente" role="tab" aria-controls="pills-pendiente" aria-selected="true">
          ...
          <div class="tab-content" id="pills-tabContent">
            <?php if($this->session->userdata('tipo') == 11){ ?>
          <div class="tab-pane fade show active" id="pills-pendienteco" role="tabpanel" aria-labelledby="pills-pendienteco-tab">
            <div class="float-right">
              <input type="text" class="form-control" placeholder="Buscar" name="busquedaPendienteCO">
            </div>
            <?php if ($clase_pagina == 'solicitudes-almacen') { ?>
            ...
            <?php } ?>
            <div class="table-responsive">
              <table id="tbsolicitudesagpendienteco" class="table table-striped table-sm">
                <thead>
                  <tr>
                    <th>UID</th>
                    <th>Neodata</th>
              ...
              <br>
              <div class="paginacionPendienteCO">
              </div>
            </div>
          </div>
          <?php } ?>
          ...
          <div class="tab-pane fade show <?= $this->session->userdata('tipo') != 11 ? 'active' : '' ?>" id="pills-pendiente" role="tabpanel" aria-labelledby="pills-pendiente-tab">
            <div class="float-right">
      ...
      <div class="tab-pane fade <?= $this->session->userdata('tipo_anterior') != null && $this->session->userdata('tipo') == 4 ? 'show active' : '' ?>" id="pills-higiene">          
          <div class="float-right">
...
<?php if($this->session->userdata('tipo') == 4 && $clase_pagina != 'solicitudes-almacen' && !isset($_SESSION['tipo_anterior'])){ ?>
<section class="tables dashboard-counts">
  <div class="container-fluid">
    <div class="card">
      <div class="card-header d-flex align-items-center">
...
<script>
  $(document).ready(function() {
    <?php if ($clase_pagina != 'solicitudes-almacen') { ?>
      ...
      <?php } ?>
      <?php if (isset($this->session->userdata('permisos')['solicitud_instalacion']) && $this->session->userdata('permisos')['solicitud_instalacion'] > 0) { ?>        
        mostrarSolicitudesInstalacion("",1,"");        
      <?php } ?>
      ...
      $("select[name='select87']").on('change', function() {
        //selectBuscar = $("select[name='selectKuali']").val();
        selectBuscar = $(this).val();
        mostrarSolicitudes87('', 1, selectBuscar);
      });
    ...
    $("input[name='busquedaCancelada']").keyup(function() {
      ...
      $("input[name='busquedaInstalacion']").keyup(function() {
        textoBuscar = $("input[name='busquedaInstalacion']").val();
        //textoBuscar2 = $("select[name='selectKuali']").val();
        mostrarSolicitudesInstalacion(textoBuscar,1,selectBuscar);
      });
      ...
      $("input[name='busqueda87']").keyup(function() {
        textoBuscar = $("input[name='busqueda87']").val();
        //textoBuscar2 = $("select[name='selectKuali']").val();
        mostrarSolicitudes87(textoBuscar,1,selectBuscar);
      });
      ...
      $("body").on("click", ".paginacionInstalacion li a", function(e) {
        e.preventDefault();
        valorHref = $(this).attr("href");
        valorBuscar = $("input[name='busquedaInstalacion']").val();
        //valorBuscar2 = $("select[name='selectKuali']").val();
        mostrarSolicitudesInstalacion(valorBuscar, valorHref, selectBuscar);
      });
      ...
      $("body").on("click", ".paginacion87 li a", function(e) {
        e.preventDefault();
        valorHref = $(this).attr("href");
        valorBuscar = $("input[name='busqueda87']").val();
        //valorBuscar2 = $("select[name='selectKuali']").val();
        mostrarSolicitudes87(valorBuscar, valorHref, selectBuscar);
      });
    ...
    <?php if ($clase_pagina == 'solicitudes-almacen') { ?>
      ...
      $("select[name='selectInstalacion']").on('change', function() {
        //selectBuscar = $("select[name='selectKuali']").val();
        selectBuscar = $(this).val();
        mostrarSolicitudesInstalacion('', 1, selectBuscar);
      });
      ...
      $("input[name='busquedaPendiente']").keyup(function() {
        textoBuscar = $("input[name='busquedaPendiente']").val();
        //textoBuscar2 = $("select[name='selectKuali']").val();
        mostrarDatosPendiente(textoBuscar,1);
      });

      $("input[name='busquedaPendienteCO']").keyup(function() {
        textoBuscar = $("input[name='busquedaPendienteCO']").val();
        //textoBuscar2 = $("select[name='selectKuali']").val();
        mostrarDatosPendienteCO(textoBuscar,1);
      });
      ...
      $("body").on("click", ".paginacionPendienteCO li a", function(e) {
        e.preventDefault();
        valorHref = $(this).attr("href");
        valorBuscar = $("input[name='busquedaPendienteCO']").val();
        mostrarDatosPendienteCO(valorBuscar, valorHref);
      });
  ...
  <?php if ($clase_pagina != 'solicitudes-almacen') { ?>
    ...
    function mostrarSolicitudesTarjetas(valorBuscar, pagina, valorBuscar2) {
      $.ajax({
        ...
        success: function(response) {
          ...
          paginador += "</ul>";
          $(".paginacionTarjetas").html(paginador);
        }
      });
    }

    function mostrarSolicitudesInstalacion(valorBuscar, pagina, valorBuscar2) {
      $.ajax({
        url: "<?= base_url() ?>Almacen/mostrarSolicitudesInstalacion",
        type: "POST",
        data: {
          buscar: valorBuscar,
          nropagina: pagina,
        ...
        success: function(response) {
          filas = "";
          $('#tbsolicitudesinstalacion tbody').html("");
          $.each(response.solicitudesInstalacion, function(key, item) {
            //if (item.tipo_producto == 'Almacen General') {
              if (item.estatus_solicitud == 'SRCV') {
                var color = 'success';
                var status = 'Surtida';
              ...
              <?php } ?>
              filas += "</tr>";
              $('#tbsolicitudesinstalacion tbody').html(filas);
            //}
          });
          linkSeleccionado = Number(pagina);
          //total registros
          ...
          paginador += "</ul>";
          $(".paginacionInstalacion").html(paginador);
        }
      });
    }
    ...
    function mostrarSolicitudes87(valorBuscar, pagina, valorBuscar2) {
      $.ajax({
        url: "<?= base_url() ?>Almacen/mostrarSolicitudes87",
        type: "POST",
        data: {
          buscar: valorBuscar,
          nropagina: pagina,
        ...
        success: function(response) {
          filas = "";
          $('#tbsolicitudes87 tbody').html("");
          $.each(response.solicitudes87, function(key, item) {
            //if (item.tipo_producto == 'Almacen General') {
              if (item.estatus_solicitud == 'S') {
                var color = 'success';
                var status = 'Surtida';
              ...
              <?php } ?>
              filas += "</tr>";
              $('#tbsolicitudes87 tbody').html(filas);
            //}
          });
          linkSeleccionado = Number(pagina);
          //total registros
  ...
  <?php if ($clase_pagina == 'solicitudes-almacen') { ?>    
    ...
    function mostrarSolicitudesInstalacion(valorBuscar, pagina, valorBuscar2) {            
      $.ajax({
        url: "<?= base_url() ?>Almacen/mostrarMisSolicitudesInstalacion",
        type: "POST",
        data: {
          buscar: valorBuscar,
          nropagina: pagina,
    ...
    function mostrarDatosPendienteCO(valorBuscar, pagina, valorBuscar2) {
      console.log("Entro");
      $.ajax({
        url: "<?= base_url() ?>Almacen/mostrarSolicitudesAGEstatus",
        type: "POST",
        ...
        success: function(response) {
          ...
          $.each(response.solicitudesAGEstatus, function(key, item) {
            if (item.tipo_producto == 'Almacen General' || item.tipo_producto == 'Seguridad e Higiene') {
              ...
              <?php } ?>
              filas += "</tr>";
              $('#tbsolicitudesagpendienteco tbody').html(filas);
            }
          });
          ...
          paginador += "</ul>";
          $(".paginacionPendienteCO").html(paginador);
        }
      });
    }
