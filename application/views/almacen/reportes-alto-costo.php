  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-header d-flex align-items-center">
        <h3 class="h4">Reportes de almacen alto costo</h3>
      </div>
      <div class="card-body">
        <div class="over"></div>
        ...
        <div class="tab-content" id="tabsContent">
          <div class="tab-pane fade active show" id="pills-proyecto" role="tabpanel" aria-labelledby="pills-proyecto-tab">
            <?= form_open('almacen/reporte_alto_costo', 'class="needs-validation" novalidate  id="formproyecto"'); ?>
              <div class="form-row">
                ...
                <div class="col-xs-12 col-md-3 col-lg-4">
                  ...
                  <select name="tipo_reporte" class="form-control" required>
                    ...
                    <option value="asignacion">Salidas</option>
          ...
          <div class="tab-pane fade" id="pills-personal" role="tabpanel" aria-labelledby="pills-personal-tab">
            <?= form_open('almacen/reporte_alto_costo', 'class="needs-validation" novalidate id="formpersonal"'); ?>
              <div class="form-row">
                ...
                <div class="col-xs-12 col-md-3 col-lg-3 divContratistas" style="display: none;">
                ...
                <div class="col-xs-12 col-md-3 col-lg-3 divInternos">
                  <div class="form-group">
                ...
                <div class="col-xs-12 col-md-3 col-lg-3">
                  <label class="form-check-label">Estatus Asignación</label>
                  <select name="estatus_asignacion" class="form-control">
                    <option value="" disabled selected>Seleccione...</option>
                    <!--<option value="entrada-almacen">Entradas</option>-->
          ...
          <div class="tab-pane fade" id="pills-productos" role="tabpanel" aria-labelledby="pills-productos-tab">
            <?= form_open('almacen/reporte_alto_costo', 'class="needs-validation" novalidate id="formproducto"'); ?>
              <div class="form-row">
                <div class="col">
                  <label>Producto*</label>
                ...
                <div class="col-xs-12 col-md-3 col-lg-4">
                  ...
                  <select name="tipo_reporte" class="form-control tipo_reporte_producto" data-id="pills-productos" required>
                    <option value="" disabled selected>Seleccione...</option>
                    <option value="entrada">Entradas</option>
                    <option value="asignacion">Salidas</option>
                    <option value="traspaso-almacen">Traspasos</option>
                    <option value="devolucion">Devoluciones</option>
                    <option value="herramientas">Herramientas Alto Costo</option>
                  </select>
                </div>
                <div class="col-xs-12 col-md-3 col-lg-3">
                  <div class="form-group estados" style="display:none;">
                    <label class="form-check-label">Estatus</label>
                    <select name="estatus" class="form-control" data-live-search="true">
                      <option value="" disabled selected>Seleccione...</option>
          ...
          <div class="tab-pane fade" id="pills-fecha" role="tabpanel" aria-labelledby="pills-fecha-tab">
            <?= form_open('almacen/reporte_alto_costo', 'class="needs-validation" novalidate id="formfecha"'); ?>
              <div class="form-row">
                <div class="colxs-12 col-md-4">
                  <label class="form-check-label">Fecha Inicial*</label>
          ...
          <div class="tab-pane fade" id="pills-almacen" role="tabpanel" aria-labelledby="pills-almacen-tab">
            <?= form_open('almacen/reporte_alto_costo', 'class="needs-validation" novalidate id="formalmacenes"'); ?>
              <div class="form-row">
...
<script>
  $(document).on('change', '.tipo_reporte_producto', function(event){
    console.log("change");
    var selectTipoReporte = $(this);
    var idParent = selectTipoReporte.data("id");
    var selectEstados = $("#" + idParent + " .estados");
    console.log(selectTipoReporte.val());
    if(selectTipoReporte.val() != "devolucion"){
      selectEstados.css("display", "none");
    }else{
      selectEstados.css("display", "block");
    }
    selectEstados.val("");
  });
  ...
  $('#formpersonal select[name="tipo_reporte"]').on('change', function(){
    var valueSelected = $(this).val();
    var tab = $("#formpersonal");
    var elementEstatusAsig = tab.find("select[name='estatus_asignacion']");
    elementEstatusAsig.val("");
    if(valueSelected == "asignacion"){
      elementEstatusAsig.prop("disabled", false);
    }else{
      elementEstatusAsig.prop("disabled", true);
    }
  });
</script>
<script>
