<section class="forms nueva-asignacion">
  ...
  <div class="card">
    <div class="card-header d-flex align-items-center">
      <h3 class="h4">Nueva Solicitud de Devolución Seguridad e Higiene</h3>
    </div>
    <div class="card-body">
      <div class="over"></div>
      ...
      <?= form_open_multipart('', 'class="needs-validation" novalidate id="form-asignacion"'); ?>
        ...
        <div class="text-right">
          ...
          <?= form_hidden('tipo_devolucion','Seguridad e Higiene') ?>
  ...
  $.ajax({
    ...
    success : function(data) {
      ...
      if (_this.val() == 'interno') {
        ...
        $('#contratista').prop("required", false);
        $('#supervisor').prop("required", false);
        $("#recibe").prop("required", true);
        $("#estatus_personal").prop("required", true);
        ...
        $('#contratista').prop("required", true);
        $('#supervisor').prop("required", true);
        $("#recibe").prop("required", true);
        $("#estatus_personal").prop("required", false);
