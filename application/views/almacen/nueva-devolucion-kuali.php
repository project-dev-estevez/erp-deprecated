<section class="forms nueva-asignacion">
  ...
  <div class="card">
    <div class="card-header d-flex align-items-center">
      <h3 class="h4">Nueva Solicitud de Devolución Kuali</h3>
    </div>
    <div class="card-body">
      <div class="over"></div>
      ...
      <?= form_open_multipart('', 'class="needs-validation" novalidate id="form-asignacion"'); ?>
                ...
                <?php foreach ($catalogo as $key => $value): ?>
                  <?php if ($value->origen == 1 && $this->session->userdata('tipo') == 5): ?>
                    <option value="<?php echo $value->idtbl_catalogo ?>"
                      ...
                      <?php echo $value->neodata.' '.$value->origen.' '.$value->modelo.' ('.substr(htmlspecialchars(trim($value->descripcion), ENT_COMPAT),0,70).')' ?>
                    </option>
        ...
        <div class="text-right">
          ...
          <?= form_hidden('tipo_devolucion','Kuali') ?>
