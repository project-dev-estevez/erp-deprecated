    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header d-flex align-items-center">
                <h3 class="h4">Generar Nuevo Ticket Soporte</h3>
            </div>
            <div class="card-body">
                <div class="over"></div>
                        ...
                        <div style="text-align: center;">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="tipo" id="tipo" class="form-control" required>
                                                ...
                                                <option value="Nuevo Proceso">Nuevo Proceso</option>
                                                <option value="Modificacion Proceso">Modificación Proceso</option>
                                    ...
                                    <?php if($this->session->userdata('id') == 3 || $this->session->userdata('id')==121){ ?>
                                    <tr>
                                        <th>Desarrollador:</th>
                                        <td>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>                                                      
                                        <td><input type="file" id="evidencias[]" name="evidencias[]" class="form-control" required multiple></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
