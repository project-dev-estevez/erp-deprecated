                        ...
                        <form id="cerrar_Pedido" class="m-2">
                            <div class="col">
                                <div class="form-group">
                                    <label>Importe Pedido</label>
                                    <input type="number" name="importe_pedido" placeholder="Importe Pedido" class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="fecha_factura" placeholder="Fecha" class="form-control">
                                </div>
                                <div class="form-group">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn <?= $this->session->userdata('id') == 50 ? '' : 'active' ?>" id="pills-pedidos-tab" data-toggle="pill" href="#pedidos"
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn <?= $this->session->userdata('id') == 50 ? 'active' : '' ?>" id="virtuales-tab" data-toggle="tab" href="#kuali" role="tab"
                   ...
                   <li class="nav-item">
                    <a class="nav-link btn" id="makili-tab" data-toggle="tab" href="#pedidosmakili" role="tab"
                    aria-controls="makili" aria-selected="false">Pedidos Makili</a>
                   </li>
                   <li class="nav-item">
                    <a class="nav-link btn" id="makili-tab" data-toggle="tab" href="#pedidoskualidekuali" role="tab"
                    aria-controls="makili" aria-selected="false">Pedidos Kuali de Kuali</a>
                   </li>
            ...
            <div class="card-body">
                ...
                <?php if($this->session->userdata('tipo') == 4 || $this->session->userdata('tipo') == 7){ ?>
                    <div class="tab-pane fade <?= $this->session->userdata('id') == 50 ? '' : 'show active' ?>" id="pedidos" role="tabpanel" aria-labelledby="pills-pedidos-tab">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade <?= $this->session->userdata('id') == 50 ? '' : 'show active' ?>" id="pedidospendientes" role="tabpanel" aria-labelledby="pills-pedidospendientes-tab">
                ...
                <div class="tab-pane fade" id="pedidoscv" role="tabpanel" aria-labelledby="pills-pedidos-tab">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="pedidospendientescv" role="tabpanel" aria-labelledby="pills-pedidoscv-tab">
                            ...
                            <a href="<?php echo base_url() ?>pedidos/excel_pedidos_cv/pendientes"
                            class="btn btn-secondary buttons-excel buttons-html5 btn-info" tabindex="0"
                            aria-controls="data-table"><span><i class="fa fa-file-excel-o"></i> Exportar a Excel</span></a>
                            <div class="table-responsive">
                        ...
                        <div class="tab-pane fade" id="progresocv" role="tabpanel" aria-labelledby="pills-progresocv-tab">
                            ...
                            <a href="<?php echo base_url() ?>pedidos/excel_pedidos_cv/Progreso"
                            class="btn btn-secondary buttons-excel buttons-html5 btn-info" tabindex="0"
                            aria-controls="data-table"><span><i class="fa fa-file-excel-o"></i> Exportar a Excel</span></a>
                            <div class="table-responsive">
                        ...
                        <div class="tab-pane fade" id="finalizadoscv" role="tabpanel" aria-labelledby="pills-finalizadosehs-tab">
                            ...
                            <a href="<?php echo base_url() ?>pedidos/excel_pedidos_cv/Finalizado"
                            class="btn btn-secondary buttons-excel buttons-html5 btn-info" tabindex="0"
                            aria-controls="data-table"><span><i class="fa fa-file-excel-o"></i> Exportar a Excel</span></a>
                            <div class="table-responsive">
            ...
            <?php if($this->session->userdata('tipo') != 4 && $this->session->userdata('tipo') != 7){ ?>
                ...
                <?php }else{ ?>
                    ...
                    <?php if($this->session->userdata('tipo') != 4 && $this->session->userdata('tipo') != 7){ ?>
                    <div class="tab-pane fade" id="pedidosmakili" role="tabpanel" aria-labelledby="pills-pedidosmakili-tab">
                        <div class="float-right">
                            <input type="text" class="form-control" placeholder="Buscar" name="busquedamakili">
                        </div>
                        <a href="<?php echo base_url() ?>pedidos/excel-pedidos-virtuales"
                        class="btn btn-secondary buttons-excel buttons-html5 btn-info" tabindex="0"
                        aria-controls="data-table"><span><i class="fa fa-file-excel-o"></i> Exportar a Excel</span></a>
                        <div class="table-responsive">
                            <table class="table table-striped table-sm table-hover" id="tbpedidosmakili">
                                <thead>
                                    <tr>
                                        <th>UID</th>
                                        <th>Neodata</th>
                            ...
                            <br>
                            <div class="paginacionmakili">
                            </div>
                        </div>
                    </div>

                    <?php }else{ ?>
                    <div class="tab-pane fade" id="pedidosmakili" role="tabpanel" aria-labelledby="pills-pedidos-tab">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link btn active" id="pills-pedidospendientesmakili-tab" data-toggle="pill" href="#pedidospendientesmakili"
                                role="tab" aria-controls="pills-pedidospendientes" aria-selected="true">Pedidos Pendientes</a>
                            </li>
                            <?php if(($this->session->userdata('tipo') == 4 && $this->session->userdata('id') != 50) || $this->session->userdata('tipo') == 7){ ?>
                            <li class="nav-item">
                                <a class="nav-link btn" id="progresoad-tab" data-toggle="tab" href="#progresomakili" role="tab"
                                aria-controls="progreso" aria-selected="false">Pedidos Progreso</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link btn" id="finalizadosmakili-tab" data-toggle="tab" href="#finalizadosmakili" role="tab"
                                aria-controls="finalizados" aria-selected="false">Pedidos Finalizados</a>
                            </li>
                            <?php } ?>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="pedidospendientesmakili" role="tabpanel" aria-labelledby="pills-pedidosmakili-tab">
                                <div class="float-right">
                                    <input type="text" class="form-control" placeholder="Buscar" name="busquedaPendientesmakili">
                                </div>
                                <a href="<?php echo base_url() ?>pedidos/excel-pedidos-virtuales"
                                class="btn btn-secondary buttons-excel buttons-html5 btn-info" tabindex="0"
                                aria-controls="data-table"><span><i class="fa fa-file-excel-o"></i> Exportar a Excel</span></a>
                                <div class="table-responsive">
                                    <table class="table table-striped table-sm table-hover" id="tbpedidospendientesmakili">
                                        <thead>
                                            <tr>
                                                <th>UIDHola</th>
                                                <th>Neodata</th>
                                    ...
                                    <br>
                                    <div class="paginacionPendientesmakili">
                                    </div>
                                </div>
                            </div>
                    
                            <div class="tab-pane fade" id="progresomakili" role="tabpanel" aria-labelledby="pills-progresomakili-tab">
                                <div class="float-right">
                                    <input type="text" class="form-control" placeholder="Buscar" name="busquedaProgresomakili">
                                </div>
                                <a href="<?php echo base_url() ?>pedidos/excel-pedidos-virtuales"
                                class="btn btn-secondary buttons-excel buttons-html5 btn-info" tabindex="0"
                                aria-controls="data-table"><span><i class="fa fa-file-excel-o"></i> Exportar a Excel</span></a>
                                <div class="table-responsive">
                                    <table class="table table-striped table-sm table-hover" id="tbpedidosprogresomakili">
                                        <thead>
                                            <tr>
                                                <th>UID</th>
                                                <th>Neodata</th>
                                    ...
                                    <br>
                                    <div class="paginacionProgresomakili">
                                    </div>
                                </div>
                            </div>
                    
                            <div class="tab-pane fade" id="finalizadosmakili" role="tabpanel" aria-labelledby="pills-finalizadosmakili-tab">
                                <div class="float-right">
                                    <input type="text" class="form-control" placeholder="Buscar" name="busquedaFinalizadomakili">
                                </div>
                                <a href="<?php echo base_url() ?>pedidos/excel-pedidos-virtuales"
                                class="btn btn-secondary buttons-excel buttons-html5 btn-info" tabindex="0"
                                aria-controls="data-table"><span><i class="fa fa-file-excel-o"></i> Exportar a Excel</span></a>
                                <div class="table-responsive">
                                    <table class="table table-striped table-sm table-hover" id="tbpedidosfinalizadomakili">
                                        <thead>
                                            <tr>
                                                <th>UID</th>
                                                <th>Neodata</th>
                                    ...
                                    <br>
                                    <div class="paginacionFinalizadomakili">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!--Fin Makili-->
                     ...
                     <?php if($this->session->userdata('tipo') != 4 && $this->session->userdata('tipo') != 7){ ?>
                    <div class="tab-pane fade" id="pedidoskualidekuali" role="tabpanel" aria-labelledby="pills-pedidoskualidekuali-tab">
                        <div class="float-right">
                            <input type="text" class="form-control" placeholder="Buscar" name="busquedakualidekuali">
                        </div>
                        <a href="<?php echo base_url() ?>pedidos/excel-pedidos-virtuales"
                        class="btn btn-secondary buttons-excel buttons-html5 btn-info" tabindex="0"
                        aria-controls="data-table"><span><i class="fa fa-file-excel-o"></i> Exportar a Excel</span></a>
                        <div class="table-responsive">
                            <table class="table table-striped table-sm table-hover" id="tbpedidoskualidekuali">
                                <thead>
                                    <tr>
                                        <th>UID</th>
                                        <th>Neodata</th>
                            ...
                            <br>
                            <div class="paginacionkualidekuali">
                            </div>
                        </div>
                    </div>

                    <?php }else{ ?>
                    <div class="tab-pane fade" id="pedidoskualidekuali" role="tabpanel" aria-labelledby="pills-pedidos-tab">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link btn active" id="pills-pedidospendienteskualidekuali-tab" data-toggle="pill" href="#pedidospendienteskualidekuali"
                                role="tab" aria-controls="pills-pedidospendientes" aria-selected="true">Pedidos Pendientes</a>
                            </li>
                           
                            <li class="nav-item">
                                <a class="nav-link btn" id="progresoad-tab" data-toggle="tab" href="#progresokualidekuali" role="tab"
                                aria-controls="progreso" aria-selected="false">Pedidos Progreso</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link btn" id="finalizadoskualidekuali-tab" data-toggle="tab" href="#finalizadoskualidekuali" role="tab"
                                aria-controls="finalizados" aria-selected="false">Pedidos Finalizados</a>
                            </li>
                            
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="pedidospendienteskualidekuali" role="tabpanel" aria-labelledby="pills-pedidoskualidekuali-tab">
                                <div class="float-right">
                                    <input type="text" class="form-control" placeholder="Buscar" name="busquedaPendienteskualidekuali">
                                </div>
                                <a href="<?php echo base_url() ?>pedidos/excel-pedidos-virtuales"
                                class="btn btn-secondary buttons-excel buttons-html5 btn-info" tabindex="0"
                                aria-controls="data-table"><span><i class="fa fa-file-excel-o"></i> Exportar a Excel</span></a>
                                <div class="table-responsive">
                                    <table class="table table-striped table-sm table-hover" id="tbpedidospendienteskualidekuali">
                                        <thead>
                                            <tr>
                                                <th>UID</th>
                                                <th>Neodata</th>
                                    ...
                                    <br>
                                    <div class="paginacionPendienteskualidekuali">
                                    </div>
                                </div>
                            </div>
                    
                            <div class="tab-pane fade" id="progresokualidekuali" role="tabpanel" aria-labelledby="pills-progresokualidekuali-tab">
                                <div class="float-right">
                                    <input type="text" class="form-control" placeholder="Buscar" name="busquedaProgresokualidekuali">
                                </div>
                                <a href="<?php echo base_url() ?>pedidos/excel-pedidos-virtuales"
                                class="btn btn-secondary buttons-excel buttons-html5 btn-info" tabindex="0"
                                aria-controls="data-table"><span><i class="fa fa-file-excel-o"></i> Exportar a Excel</span></a>
                                <div class="table-responsive">
                                    <table class="table table-striped table-sm table-hover" id="tbpedidosprogresokualidekuali">
                                        <thead>
                                            <tr>
                                                <th>UID</th>
                                                <th>Neodata</th>
                                    ...
                                    <br>
                                    <div class="paginacionProgresokualidekuali">
                                    </div>
                                </div>
                            </div>
                    
                            <div class="tab-pane fade" id="finalizadoskualidekuali" role="tabpanel" aria-labelledby="pills-finalizadoskualidekuali-tab">
                                <div class="float-right">
                                    <input type="text" class="form-control" placeholder="Buscar" name="busquedaFinalizadokualidekuali">
                                </div>
                                <a href="<?php echo base_url() ?>pedidos/excel-pedidos-virtuales"
                                class="btn btn-secondary buttons-excel buttons-html5 btn-info" tabindex="0"
                                aria-controls="data-table"><span><i class="fa fa-file-excel-o"></i> Exportar a Excel</span></a>
                                <div class="table-responsive">
                                    <table class="table table-striped table-sm table-hover" id="tbpedidosfinalizadokualidekuali">
                                        <thead>
                                            <tr>
                                                <th>UID</th>
                                                <th>Neodata</th>
                                    ...
                                    <br>
                                    <div class="paginacionFinalizadokualidekuali">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <?php }else{ ?>
                        <div class="tab-pane fade <?= $this->session->userdata('id') == 50 ? 'show active' : '' ?>" id="kuali" role="tabpanel" aria-labelledby="pills-pedidos-tab">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
...
$(document).ready(function() {
    ...
    $("input[name='busquedaFinalizadoehs']").keyup(function() {
        ...
        //Kuali de kuali
        mostrarDatosPendienteskualidekuali("", 1, "");

        $("select[name='selectPendienteskualidekuali']").on('change', function(){
            selectBuscar = $(this).val();
            mostrarDatosPendienteskualidekuali('', 1, selectBuscar);
        });
        $("input[name='busquedaPendienteskualidekuali']").keyup(function(){
            textoBuscar = $("input[name='busquedaPendienteskualidekuali']").val();
            mostrarDatosPendienteskualidekuali(textoBuscar, 1, selectBuscar);
        });

        $("body").on("click", ".paginacionPendienteskualidekuali li a", function(e){
            e.preventDefault();
            valorHref = $(this).attr("href");
            valorBuscar = $("input[name='busquedaPendienteskualidekuali']").val();
            mostrarDatosPendienteskualidekuali(valorBuscar, valorHref, selectBuscar);
        });

        mostrarDatosProgresokualidekuali("", 1, "");

        $("select[name='selectProgresokualidekuali']").on('change', function(){
            selectBuscar = $(this).val();
            mostrarDatosProgresokualidekuali('', 1, selectBuscar);
        });
        $("input[name='busquedaProgresokualidekuali']").keyup(function(){
            textoBuscar = $("input[name='busquedaProgresokualidekuali']").val();
            mostrarDatosProgresokualidekuali(textoBuscar, 1, selectBuscar);
        });

        $("body").on("click", ".paginacionProgresokualidekuali li a", function(e){
            e.preventDefault();
            valorHref = $(this).attr("href");
            valorBuscar = $("input[name='busquedaProgresokualidekuali']").val();
            mostrarDatosProgresokualidekuali(valorBuscar,valorHref, selectBuscar);
        });

        mostrarDatosFinalizadokualidekuali("", 1, "");

$("select[name='selectFinaizadokualidekuali']").on('change', function(){
    selectBuscar = $(this).val();
    mostrarDatosFinalizadokualidekuali('', 1, selectBuscar);
});
$("input[name='busquedaFinalizadokualidekuali']").keyup(function(){
    textoBuscar = $("input[name='busquedaFinalizadokualidekuali']").val();
    mostrarDatosFinalizadokualidekuali(textoBuscar, 1, selectBuscar);
});

$("body").on("click", ".paginacionFinalizadokualidekuali li a", function(e){
    e.preventDefault();
    valorHref = $(this).attr("href");
    valorBuscar = $("input[name='busquedaFinalizadokualidekuali']").val();
    mostrarDatosFinalizadokualidekuali(valorBuscar,valorHref, selectBuscar);
});
    ...
    $("input[name='busquedaFinalizadopersonal']").keyup(function() {
        ...
        //Makili
        mostrarDatosPendientesmakili("", 1, "");
        $("select[name='selectPendientesmakili']").on('change', function(){
            selectBuscar = $(this).val();
            mostrarDatosPendientesmakili('', 1, selectBuscar);            
        });
        $("input[name='busquedaPendientesmakili']").keyup(function(){
            textoBuscar = $("input[name='busquedaPendientesmakili']").val();
            mostrarDatosPendientesmakili(textoBuscar, 1, selectBuscar);
        });        

        $("body").on("click", ".paginacionPendientesmakili li a", function(e){
        e.preventDefault();
        valorHref = $(this).attr("href");
        valorBuscar = $("input[name='busquedaPendientesmakili']").val();
        mostrarDatosPendientesmakili(valorBuscar, valorHref, selectBuscar);
        });
    
        mostrarDatosProgresomakili("", 1, "");
        $("select[name='selectProgresomakili']").on('change', function(){
            selectBuscar = $(this).val();
            mostrarDatosProgresomakili('', 1, selectBuscar);
        });        
        $("input[name='busquedaProgresomakili']").keyup(function(){
            textoBuscar = $("input[name='busquedaProgresomakili']").val();
            mostrarDatosProgresomakili(textoBuscar, 1, selectBuscar);
        });
        $("body").on("click", ".paginacionProgresomakili li a", function(e){
            e.preventDefault();
            valorHref = $(this).attr("href");
            valorBuscar = $("input[name='busquedaProgresomakili']").val();
            mostrarDatosProgresomakili(valorBuscar, valorHref, selectBuscar);
        });

        mostrarDatosFinalizadomakili("", 1, "");
        $("select[name='selectFinalizadomakili']").on('change', function(){
            selectBuscar = $(this).val();
            mostrarDatosFinalizadomakili('', 1, selectBuscar);
        });
        $("input[name='busquedaFinalizadomakili']").keyup(function(){
            textoBuscar = $("input[name='busquedaFinalizadomakili']").val();
            mostrarDatosFinalizadomakili(textoBuscar, 1, selectBuscar);
        });

        $("body").on("click", ".paginacionFinalizadomakili li a", function(e){
            e.preventDefault();
            valorHref = $(this).attr("href");
            valorBuscar = $("input[name='busquedaFinalizadomakili']").val();
            mostrarDatosFinalizadomakili(valorBuscar, valorHref, selectBuscar);
        });
    ...
    $("input[name='busquedaPendienteskuali']").keyup(function() {
        ...
        mostrarDatosPendientesKuali(valorBuscar, valorHref, selectBuscar);
        });
        ...
        success: function(response) {
            ...
            $.each(response.pedidos, function(key, item) {
                ...
                <?php } ?>                
                    ...
                    <?php } ?>
                    filas += "<td><a href='" + "<?= base_url() ?>pedidos/detalle-pedido/" + item
                        .uid +
            ...
            $.each(response.pedidos, function(key, item) {
                ...
                <?php } ?>;
                    ...
                    filas += "<td><a href='" + "<?= base_url() ?>pedidos/detalle-pedido/" + item
                        ...
                        "' title='Detalle'>" + "<i class='fa fa-info-circle'></i>" + "</a>";
                    <?php if($this->session->userdata('tipo') == 4) { ?>
                    if (item.entrada_virtual == 0 && item.entregado == 0 && item.estatus !=
                        'cancelada') {
                        filas +=
                            "<td><a href='#entrada_virtual' data-toggle='modal' title='Entrada Virtual'" +
                            " data-idpedido='" + item.idtbl_pedidos + "'" + " data-proyecto='" +
...
function mostrarDatosMakili(valorBuscar, pagina, valorBuscar2) {
    $.ajax({
        ...
        success: function(response) {
            filas = "";
            $.each(response.pedidosmakili, function(key, item) {
            ...
            $('#tbpedidosmakili tbody').html(filas);
            ...
            paginador += "</ul>";
            $(".paginacionmakili").html(paginador);
        }
    });
}

function mostrarDatosPendientesmakili(valorBuscar, pagina, valorBuscar2) {
    $.ajax({
        url: "<?= base_url() ?>Pedidos/mostrarPedidosmakili",
        type: "POST",
        data: {
...
function mostrarDatosProgresomakili(valorBuscar, pagina, valorBuscar2) {
    $.ajax({
        url: "<?= base_url() ?>Pedidos/mostrarPedidosmakili",
        type: "POST",
        data: {
        ...
        success: function(response) {
            ...
            paginador += "</ul>";
            $(".paginacionProgresomakili").html(paginador);
        }
    });
}
...
function mostrarDatosFinalizadomakili(valorBuscar, pagina, valorBuscar2) {
    $.ajax({
        url: "<?= base_url() ?>Pedidos/mostrarPedidosmakili",
        type: "POST",
        data: {
        ...
        success: function(response) {
            ...
            $('#tbpedidosfinalizadomakili tbody').html(filas);
            ...
            paginador += "</ul>";
            $(".paginacionFinalizadomakili").html(paginador);
        }
    });
}
...
function mostrarDatoskualidekuali(valorBuscar, pagina, valorBuscar2) {
    $.ajax({
        url: "<?= base_url() ?>Pedidos/mostrarPedidoskualidekuali",
        type: "POST",
        data: {
            buscar: valorBuscar,
            nropagina: pagina,
        ...
        success: function(response) {
            filas = "";
            $.each(response.pedidoskualidekuali, function(key, item) {
            ...
            $('#tbpedidoskualidekuali tbody').html(filas);
            ...
            paginador += "</ul>";
            $(".paginacionkualidekuali").html(paginador);
        }
    });
}

function mostrarDatosPendienteskualidekuali(valorBuscar, pagina, valorBuscar2) {
    $.ajax({
        url: "<?= base_url() ?>Pedidos/mostrarPedidoskualidekuali",
        type: "POST",
        data: {
        ...
        success: function(response) {
            ...
            $('#tbpedidospendienteskualidekuali tbody').html(filas);
            ...
            paginador += "</ul>";
            $(".paginacionPendienteskualidekuali").html(paginador);
        }
    });
}

function mostrarDatosProgresokualidekuali(valorBuscar, pagina, valorBuscar2) {
    $.ajax({
        url: "<?= base_url() ?>Pedidos/mostrarPedidoskualidekuali",
        type: "POST",
        data: {
        ...
        success: function(response) {
            ...
            $('#tbpedidosprogresokualidekuali tbody').html(filas);
            ...
            paginador += "</ul>";
            $(".paginacionProgresokualidekuali").html(paginador);
        }
    });
}

function mostrarDatosFinalizadokualidekuali(valorBuscar, pagina, valorBuscar2) {
    $.ajax({
        url: "<?= base_url() ?>Pedidos/mostrarPedidosKualidekuali",
        type: "POST",
        data: {
        ...
        success: function(response) {
            ...
            $('#tbpedidosfinalizadokualidekuali tbody').html(filas);
            ...
            paginador += "</ul>";
            $(".paginacionFinalizadokualidekuali").html(paginador);
        }
    });
}
